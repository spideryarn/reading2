...
doc, in a commit message — use plain words and short sentences, and stop when the point is made. Say
the thing itself, not a gesture at it. No jargon where an ordinary word will do, no hedging padding,
no retelling what the reader has just read.

    ...
    rows: [
      {
        ...
        /* The witness is the same string as `articleReferenceQuote` — that is
           ...
           **The `quoted` signal beside it is what keeps this row on screen**, and
           it arrived with Debate's identification bar on 2026-09-07. The bar
           defaults to `quoted` — measured on the corpus, because a page that

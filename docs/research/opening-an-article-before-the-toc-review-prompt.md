...
**The doc is `docs/research/opening-an-article-before-the-toc.md`.** Read it in full first.
...
(`docs/plans/defer-arc-and-rename-hierarchy.md`), which is the immediately preceding piece of work

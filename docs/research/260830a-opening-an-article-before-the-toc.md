...
findings are in
[`260830a-opening-an-article-before-the-toc-sol.md`](260830a-opening-an-article-before-the-toc-sol.md), and the
...
[`docs/plans/260829f-defer-arc-and-rename-hierarchy.md`](../plans/260829f-defer-arc-and-rename-hierarchy.md)).
...
The same error was in [`docs/plans/260829f-defer-arc-and-rename-hierarchy.md`](../plans/260829f-defer-arc-and-rename-hierarchy.md),
...
into the room it is given — the lesson of `docs/postmortems/260826a-toc-max-tokens.md`.
...
[260826a-toc-max-tokens.md](../postmortems/260826a-toc-max-tokens.md) are about. A four- or five-level tree over a
...
[260830a-the-article-with-one-heading.md](../postmortems/260830a-the-article-with-one-heading.md) — is off by one

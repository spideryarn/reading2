...
[postgres-migration.md](../plans/postgres-migration.md) already puts this on every table:
...
[deploy-and-repo-move.md § RLS and realtime](../plans/deploy-and-repo-move.md#rls-and-realtime-not-now)
...
[§ The beta gate](../plans/deploy-and-repo-move.md#the-beta-gate) is afraid of. The cost is proxying
...
[§ RLS and realtime](../plans/deploy-and-repo-move.md#rls-and-realtime-not-now) decided the browser
...
- [deploy-and-repo-move.md § The beta gate](../plans/deploy-and-repo-move.md#the-beta-gate) — what the

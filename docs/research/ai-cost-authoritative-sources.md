...
- This project's own [ai-cost-tracking.md](../plans/ai-cost-tracking.md) and
  [ai-cost-tracking-options.md](ai-cost-tracking-options.md) — read in full before this research pass

## See also

- [ai-cost-tracking.md](../plans/ai-cost-tracking.md) — the plan this research feeds into
- [ai-cost-tracking-options.md](ai-cost-tracking-options.md) — the first research round (options

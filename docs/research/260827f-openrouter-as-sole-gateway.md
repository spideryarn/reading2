...
See also [260826d-prompt-caching-openrouter.md](260826d-prompt-caching-openrouter.md) (2026-08-26) — the earlier,
...
- `zed-industries/zed` #52576 — `native_tokens_cached` stays 0 through OpenRouter + Sonnet, closed via
  ...
  cited in [260826d-prompt-caching-openrouter.md](260826d-prompt-caching-openrouter.md).)
...
([260826d-prompt-caching-openrouter.md](260826d-prompt-caching-openrouter.md)) independently arrived at the same
...
This repeats and extends [260826d-prompt-caching-openrouter.md](260826d-prompt-caching-openrouter.md) (2026-08-26,
...
- **Automatic (default, no config):** OpenRouter "recognizes a conversation by hashing its first
  ...
  ([260826d-prompt-caching-openrouter.md](260826d-prompt-caching-openrouter.md)) already flagged as a poor fit for
...
- [openrouter.ai/docs/guides/best-practices/prompt-caching](https://openrouter.ai/docs/guides/best-practices/prompt-caching) — referenced, not re-fetched this session (already used in 260826d-prompt-caching-openrouter.md, 2026-08-26)
...
- `github.com/zed-industries/zed` issue #52576 — via search summary (already cited in 260826d-prompt-caching-openrouter.md)
...
- This app's own prior research, load-bearing and re-confirmed rather than re-derived:
  [docs/research/260826d-prompt-caching-openrouter.md](260826d-prompt-caching-openrouter.md) (2026-08-26),

...
[remote-server-for-claude-code.md](remote-server-for-claude-code.md) and
[`infra/hetzner/`](../../infra/hetzner/README.md). Browser work on the box, once you are in, is
[playwright-browser-control.md](playwright-browser-control.md), because Claude in Chrome cannot
...
[remote-server-for-claude-code.md](remote-server-for-claude-code.md#claude-code-on-the-box); repeated

...
[260831c-the-exit-status-that-belonged-to-tee.md](260831c-the-exit-status-that-belonged-to-tee.md) — has a rule that a
...
1. **Make `check()` prove at least one check can fail, on every run.** The mosh probe in
   [260831c-the-exit-status-that-belonged-to-tee.md](260831c-the-exit-status-that-belonged-to-tee.md) said "UDP
...
- [260831c-the-exit-status-that-belonged-to-tee.md](260831c-the-exit-status-that-belonged-to-tee.md) — the earlier

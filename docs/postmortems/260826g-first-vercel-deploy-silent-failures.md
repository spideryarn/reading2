...
[the beta gate](../plans/260825d-deploy-and-repo-move.md#the-beta-gate).
...
([260825f-postgres-migration.md](../plans/260825f-postgres-migration.md) step 9), the read path

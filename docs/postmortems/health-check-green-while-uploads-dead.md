...
[pdf-upload-and-storage.md](../plans/pdf-upload-and-storage.md) opens with a readiness table, and one
row reads:
...
- [first-vercel-deploy-silent-failures.md](first-vercel-deploy-silent-failures.md) — four bugs in the
...
- [silent-success.md](../reusable/silent-success.md) — reporting a value is not having an opinion
  about it
- [pdf-upload-and-storage.md](../plans/pdf-upload-and-storage.md) — the plan, and the readiness table

...
([reader-profile.md](../plans/260826t-reader-profile.md)), typed by the reader in their own words, fed to
...
([260825f-postgres-migration.md § The order of work](../plans/260825f-postgres-migration.md)). It wrote four of the
five shelf columns:
...
- [260828a-the-config-file-is-not-the-bucket.md](260828a-the-config-file-is-not-the-bucket.md) — a declaration and the

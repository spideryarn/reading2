...
[260827o-raw-bytes-in-storage.md](../plans/260827o-raw-bytes-in-storage.md) claims those three content types were
...
([260826u-pdf-upload-and-storage.md](../plans/260826u-pdf-upload-and-storage.md): *"Is the bucket's MIME allowlist
...
and the one [260827b-health-check-green-while-uploads-dead.md](260827b-health-check-green-while-uploads-dead.md) is
...
[260827o-raw-bytes-in-storage-review-4-sol.md](../plans/260827o-raw-bytes-in-storage-review-4-sol.md), finding 7,
confidence 95%:

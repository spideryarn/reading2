...
([chat-mode.md § Editing a question](../plans/chat-mode.md#editing-a-question)) had never worked at
...
([chat-mode.md § What a browser pass found](../plans/chat-mode.md)) drove the panel hard and reported
...
- [chat-mode.md](../plans/chat-mode.md) — the plan, and the two reviews that missed this

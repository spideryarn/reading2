...
2. **Every check passed, and all of them were honest.** `GET /api/health` reports
   ...
   [260827b-health-check-green-while-uploads-dead.md](260827b-health-check-green-while-uploads-dead.md), which is
...
[260828z-embedding-endpoints-refused.md § the probe](../plans/260828z-embedding-endpoints-refused.md).

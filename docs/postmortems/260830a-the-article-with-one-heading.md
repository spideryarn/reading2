...
([260826a-toc-max-tokens.md](260826a-toc-max-tokens.md)). It retried at double the reasoning allowance, and more
...
[260826a-toc-max-tokens.md](260826a-toc-max-tokens.md)) and it is the only thing standing between a model that
...
[`docs/plans/260828o-footnotes.md`](../plans/260828o-footnotes.md) says that must never happen — the apparatus is
...
- **If some are large**, snapping a boundary silently rewrites the model's answer into a different
  ...
  [260826a-toc-max-tokens.md](260826a-toc-max-tokens.md) deliberately refused to do, and it must not be built.
...
- [260826a-toc-max-tokens.md](260826a-toc-max-tokens.md) — the exact-set label contract, and why it exists

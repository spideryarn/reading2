...
[`3897bc9`](../plans/sketch-diagram.md) — *"Sketch becomes a fourth chip, and the first step that does
...
- **`sketch.json` had no entry in the artefact manifest**
  ...
  [export-never-wrote-the-readers-purpose.md](export-never-wrote-the-readers-purpose.md) is about.
...
- [export-never-wrote-the-readers-purpose.md](export-never-wrote-the-readers-purpose.md) — the same
...
- [the-config-file-is-not-the-bucket.md](the-config-file-is-not-the-bucket.md) — a declaration and

...
[260826m-simplification-audit.md §0.2](../plans/260826m-simplification-audit.md) — *"under investigation, not yet
...
the same shape [260826c-half-swapped-message-ids.md](260826c-half-swapped-message-ids.md) already named: *"the half
...
This also settles [260826m-simplification-audit.md §2.4](../plans/260826m-simplification-audit.md), which proposes
...
[260826c-half-swapped-message-ids.md](260826c-half-swapped-message-ids.md#the-lesson-worth-carrying): a function
...
- [260826m-simplification-audit.md](../plans/260826m-simplification-audit.md) §2.4 — the shared-hook proposal this
  bug has to be fixed ahead of
- [260826c-half-swapped-message-ids.md](260826c-half-swapped-message-ids.md) — the same "the half that was tested was

...
| **A worktree per agent** | already planned in `CLAUDE.md` | Two full runs during this work went red purely from peers on the box, and one of them nearly got read as a regression. |

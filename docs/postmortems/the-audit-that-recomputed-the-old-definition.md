...
- **The fixture set is the real hole.** This audit's power depends on what happens to be in a
  ...
  [tree-sweep-2026-08-31-review-sol.md](../plans/tree-sweep-2026-08-31-review-sol.md) § Claim 3. **A
...
- **Grepping for the wording is not checking the claim.** The same day and the same tree produced
  [the-scroller-that-mounted-after-the-measure.md](the-scroller-that-mounted-after-the-measure.md)'s

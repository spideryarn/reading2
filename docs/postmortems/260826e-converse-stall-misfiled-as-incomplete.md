...
[`docs/plans/260826l-explain-deeper-answers.md § 2 Streaming the answer`](../plans/260826l-explain-deeper-answers.md#2-streaming-the-answer-done).
...
[`docs/plans/260826m-simplification-audit.md § 0.1`](../plans/260826m-simplification-audit.md) picked it up as a
...
2. **Later: `docs/plans/260826m-simplification-audit.md § 3.4`**, extracting a shared OpenRouter streaming
...
`260826m-simplification-audit.md` already says as much: "Then §3.4 stops it recurring."
...
- **A plan that names a gap should also open a follow-up for it**, not just record it in prose. The
  ...
  without an item tracking `converse.ts`. `260826m-simplification-audit.md § 0.1` is that follow-up,
  eleven-plus commits later.
- **The shared-transport instinct was right the first time.** `docs/plans/260826m-simplification-audit.md`
...
Yes, and it is already scheduled: `docs/plans/260826m-simplification-audit.md § 3.4`. The right boundary is
...
- [`docs/plans/260826m-simplification-audit.md § 0.1`](../plans/260826m-simplification-audit.md) — the item that
  requested this postmortem, and § 3.4 — the shared-transport extraction this bug is the evidence
  for
- [`docs/plans/260826l-explain-deeper-answers.md § 2`](../plans/260826l-explain-deeper-answers.md#2-streaming-the-answer-done) —

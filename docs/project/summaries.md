...
[../plans/gist-only-summaries.md](../plans/gist-only-summaries.md) for what went, and
...
a new stage; this document and [../plans/gist-only-summaries.md](../plans/gist-only-summaries.md) are
...
- **A section whose gist is subtly wrong** is undetectable from here. Nothing catches a plausible
  ...
  [../plans/chat-mode.md](../plans/chat-mode.md) leaves behind. The gists come from
...
- [../plans/gist-only-summaries.md](../plans/gist-only-summaries.md) — **read this if you are
...
- [../plans/bottom-bar.md](../plans/bottom-bar.md) — the bar the Summary button lives in

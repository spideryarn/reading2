...
So yes: [the plan’s two reconciliations](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/ai-cost-tracking.md:845) collapse to one provider-cost path. That is real simplification, not slideware.

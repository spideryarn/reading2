...
[the research](../research/opening-an-article-before-the-toc.md): *"re 'build the two repairs' and
'the heading tree'. Proceed, perhaps with advice from GPT Sol, and definitely with review from GPT
Sol."*

The review is [toc-repairs-and-heading-tree-review-sol.md](toc-repairs-and-heading-tree-review-sol.md),
against [the prompt](toc-repairs-and-heading-tree-review-prompt.md). Three of its findings changed
...
`docs/plans/title-normalisation-review7-prompt.md`. The typecheck errors in

...
```diff
diff --git a/docs/plans/readability-repair-pass.md b/docs/plans/readability-repair-pass.md
index 58904a1..7b091ca 100644
--- a/docs/plans/readability-repair-pass.md
+++ b/docs/plans/readability-repair-pass.md

...
results file. The prompt is [260828l-dictation-vocabulary-review-prompt.md](260828l-dictation-vocabulary-review-prompt.md);
what it changed is in [260828l-dictation-vocabulary.md § What the review changed](260828l-dictation-vocabulary.md#what-the-review-changed).
...
4. **High — several stated conclusions contradict the table.** In [docs/plans/260828l-dictation-vocabulary.md](260828l-dictation-vocabulary.md):
...
9. **Medium — the full-article request cost is both significant and absent from timing.** `loadArticle` fetches every block and sanitises them through jsdom ([src/store/pg.ts](../../src/store/pg.ts), lines 569–602 and 1099–1119). Existing measurements put that sanitisation at 76–184 ms locally before production network latency ([docs/plans/260828c-library-read-latency.md](260828c-library-read-latency.md), lines 46–50).

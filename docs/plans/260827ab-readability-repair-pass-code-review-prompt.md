...
`docs/plans/260827ab-readability-repair-pass-review-sol.md` and most of it was acted on.

## What to read

- `docs/plans/260827ab-readability-repair-pass.md` — the plan, rewritten after your review

...
[prompt-caching-callsites.md](../research/prompt-caching-callsites.md) (where the money goes),
[prompt-caching-anthropic.md](../research/prompt-caching-anthropic.md) (mechanics and pricing),
[prompt-caching-openrouter.md](../research/prompt-caching-openrouter.md) (the request-path calls).
...
([prompt-caching-callsites.md § Is a cross-feature shared prefix actually
achievable?](../research/prompt-caching-callsites.md#is-a-cross-feature-shared-prefix-actually-achievable)).
...
- All three: pin `provider: { order: ["anthropic"], allow_fallbacks: false }` — a cache lives on
  ...
  ([prompt-caching-openrouter.md](../research/prompt-caching-openrouter.md#provider-routing-and-whether-pinning-is-needed)).
...
([prompt-caching-anthropic.md § Concurrency](../research/prompt-caching-anthropic.md#7-concurrency)).
...
- [prompt-caching-callsites.md](../research/prompt-caching-callsites.md) — the audit this plan executes
- [prompt-caching-anthropic.md](../research/prompt-caching-anthropic.md) /
  [prompt-caching-openrouter.md](../research/prompt-caching-openrouter.md) — mechanics
...
[prompt-caching-review-prompt.md](prompt-caching-review-prompt.md); **run it at a lower effort**, or

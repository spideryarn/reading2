...
(`docs/plans/late-steps-read-the-store-review-sol.md`,
`docs/plans/finish-the-database-move-review-sol.md`). Both verdicts were accepted, and the plan was
...
The plan: `docs/plans/finish-the-database-move.md` § The stages § Stage 1.

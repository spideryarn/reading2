...
`docs/plans/260828aw-outline-mode.md`. Read it in full first.
...
6. **What is missing from the plan entirely?** Accessibility, touch (`docs/project/touch.md` — this
   ...
   narrowed in parallel (`docs/plans/260828ay-spine-rail.md`), or anything else it has not thought about.

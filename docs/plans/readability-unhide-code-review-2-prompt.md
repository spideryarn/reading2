...
`docs/plans/readability-unhide-code-review-sol.md`, in this repo — read it first. This is the
...
`docs/plans/readability-unhide-code-review-sol.md`, `src/extract.ts`, `evals/extraction/corpus.mts`,
`tests/extract-unhide.test.ts`, `docs/plans/readability-repair-pass.md`,

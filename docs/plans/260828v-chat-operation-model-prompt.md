...
rearchitecting. Your answer is in `docs/plans/260828p-chat-client-architecture-sol.md` — the operation model,
the admission gate, the staged path 1–4. Step 1 was built from it and you reviewed the code twice
(`docs/plans/260828p-chat-client-architecture-review-sol.md`, `...-recheck-sol.md`); both blockers you raised
were fixed and it is committed as `2d0449e`.

Greg has now asked for steps 2–4 to be built. **`docs/plans/260828v-chat-operation-model.md` is the build
plan.** Review it before any code is written.

## What to read

- `docs/plans/260828v-chat-operation-model.md` — the plan under review.
- `docs/plans/260828p-chat-client-architecture.md` — the strategy it implements, including what step 1
  actually built and the three claims I got wrong along the way.
- `docs/plans/260828p-chat-client-architecture-sol.md` — your own answer, for what I have changed and why.

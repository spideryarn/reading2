...
The bug that started this is written up in [toc-max-tokens.md](../postmortems/toc-max-tokens.md).
...
- **A heading's label was still not the heading.** The prompt says copy it EXACTLY; the model does
  ...
  postmortem](../postmortems/toc-max-tokens.md), which was patched by comparing more loosely. Sol's
...
- [toc-max-tokens.md](../postmortems/toc-max-tokens.md) — the bug, and why the bridge was a bridge

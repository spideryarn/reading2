...
(`docs/plans/260902f-make-referee-mode-understandable-review-sol.md`). The plan was revised against
...
`docs/plans/260902f-make-referee-mode-understandable.md` is the revised plan. Its § *Stage 1a* and

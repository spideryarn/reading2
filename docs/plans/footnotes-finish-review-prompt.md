...
(`docs/plans/footnotes-finish-upfront-sol.md`, verdict PROCEED WITH SMALL CHANGES). This is the
...
The diff is `docs/plans/footnotes-finish.diff` (799 lines). It is **scoped to my hunks

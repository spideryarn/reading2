...
The plan currently says a fresh `test-c7-clean` clone already proved this at [260827aa-delete-the-importer.md](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/260827aa-delete-the-importer.md:877), contradicting “I have not yet run it clean.” Resolve that evidence statement.

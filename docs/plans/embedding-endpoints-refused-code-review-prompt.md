...
`docs/plans/embedding-endpoints-refused-sol.md` and the diagnosis is
`docs/plans/embedding-endpoints-refused.md`. Read-only, in `spideryarn2`. Read `CLAUDE.md` first.

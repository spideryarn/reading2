...
**Write each finding to `/tmp/260910f-launch-protocol-stage2-review-sol-findings.md` as soon as
...
For each finding: an ID (continue from F20), a severity, established (you ran it or can point at the

...
Reference for [chat-operation-model.md](chat-operation-model.md). All line numbers are against
...
document itself ([chat-operation-model.md](chat-operation-model.md), the "Why `base` is..."

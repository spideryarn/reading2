...
date** — where [tweet-thread-page.md](tweet-thread-page.md) does say exactly that. Recorded as open
...
- [tweet-thread-page.md](tweet-thread-page.md) — the staleness sentence to match
- [postgres-storage-implementation.md](postgres-storage-implementation.md) — the store seam

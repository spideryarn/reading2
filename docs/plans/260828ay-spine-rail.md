...
postmortem goes in `docs/postmortems/260828g-spine-hover-cards.md`.
...
- GPT Sol on this plan before building (`260828ay-spine-rail-review-sol.md`) and on the diff after
  (`260828ay-spine-rail-code-review-sol.md`).

...
The source route cannot wait until a later demolition step: the plan itself says it must move no later than D [260827aa-delete-the-importer.md:1255](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/260827aa-delete-the-importer.md:1255).

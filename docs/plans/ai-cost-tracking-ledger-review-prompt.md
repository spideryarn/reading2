...
[`docs/plans/ai-cost-tracking-rows-sol.md`](ai-cost-tracking-rows-sol.md), which you wrote this
...
- [`docs/plans/ai-cost-tracking.md`](ai-cost-tracking.md) — the plan, with a 2026-08-28 status block
...
diff --git a/docs/plans/ai-cost-tracking.md b/docs/plans/ai-cost-tracking.md
index 9982dd6..4d61d3f 100644
--- a/docs/plans/ai-cost-tracking.md
+++ b/docs/plans/ai-cost-tracking.md
...
async function main(): Promise<void> {
  ...
  /* Said every time rather than only when it looks wrong: a CLI stage run opens
     ...
     other end of that. docs/plans/ai-cost-tracking.md. */

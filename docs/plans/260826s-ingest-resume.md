...
[260826e-postgres-storage-implementation.md](260826e-postgres-storage-implementation.md) — its progress table and its
[ordered next steps](260826e-postgres-storage-implementation.md#what-happens-next-in-order) are the
...
[260826q-job-queue-rethink.md](260826q-job-queue-rethink.md).
...
[the first item on the next-steps list](260826e-postgres-storage-implementation.md#what-happens-next-in-order).
...
- [260826q-job-queue-rethink.md](260826q-job-queue-rethink.md) — why the queue is browser-driven, and the ingest that does not work on Vercel today
- [260826e-postgres-storage-implementation.md](260826e-postgres-storage-implementation.md) — the progress table and the ordered next steps

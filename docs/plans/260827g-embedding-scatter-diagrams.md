...
**Status: built, 2026-08-27.** Builds on [260826ah-diagram-mode.md](260826ah-diagram-mode.md) (the six pictures) and
[260827d-force-diagram-links.md](260827d-force-diagram-links.md) (which put embeddings behind `POST
/api/similar/:slug`). Nothing here re-litigates the embedding model — that was measured in
[260826n-semantic-search.md](260826n-semantic-search.md) and it is `voyageai/voyage-4`.
...
[260826n-semantic-search.md](260826n-semantic-search.md)'s job — pgvector, a migration, a re-embed rule and a place
...
- **No persistence.** Memory cache, as above. When [260826n-semantic-search.md](260826n-semantic-search.md) lands,

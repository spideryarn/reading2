...
Therefore the plan’s “No JavaScript changes” claim at [`mobile-screen-real-estate.md:159`](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/mobile-screen-real-estate.md:159) is false.
...
The assertion at [`mobile-screen-real-estate.md:139`](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/mobile-screen-real-estate.md:139) that all insets are zero outside an installed app must go.
...
The unresolved on-screen-keyboard issue from [`mobile-reading-view.md`](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/mobile-reading-view.md:193) also remains.

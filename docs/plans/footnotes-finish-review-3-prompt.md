...
Your second review (`docs/plans/footnotes-finish-review-2-sol.md`) confirmed the continuation
...
`docs/plans/footnotes-finish.diff` — 1319 lines now, and genuinely complete this time; the

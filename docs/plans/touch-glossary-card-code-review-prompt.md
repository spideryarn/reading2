...
- `docs/plans/touch-glossary-card.md` — the plan, now updated, with a **§ What the review changed**
  saying which of your nine landed and which two were declined and why.
- `docs/plans/touch-glossary-card-review-sol.md` — your own nine findings, for reference.
- A scoped diff is at

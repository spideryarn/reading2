...
[260826m-simplification-audit.md](260826m-simplification-audit.md) Rule 1, *grep the genre, not
...
- [260826e-postgres-storage-implementation.md](260826e-postgres-storage-implementation.md) — the

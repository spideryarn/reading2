...
[260826p-error-boundary.md](260826p-error-boundary.md) is a record of the same bug found four
...
([the answer](260827y-error-monitoring-sentry-review-sol.md)) says why with evidence out
...
1. **The scrub, against the real leak.** Build a `DrizzleQueryError`-shaped error
   ...
   260826p-error-boundary.md sentinel test, narrowed to one egress — and unlike that one,
   it is a few lines.
...
[GPT Sol's review](260827y-error-monitoring-sentry-review-sol.md) turned four of the
...
- [260826p-error-boundary.md](260826p-error-boundary.md) — the rule this plan's scrub implements,

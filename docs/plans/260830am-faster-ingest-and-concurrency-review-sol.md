...
5. **P0 — Assets still gate the real tree, contrary to the plan.**
   ...
   The diagram publishes the real tree only after `assets` ([plan](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/260830am-faster-ingest-and-concurrency.md:174)). If ToC succeeds after 320 seconds and assets then fails, the reader remains on the provisional tree and the expensive result is unpublished.

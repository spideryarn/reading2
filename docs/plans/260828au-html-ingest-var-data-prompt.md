...
points at `docs/plans/260827j-transactional-stage-runner.md`.

**7. There is an in-flight plan that fixes exactly this**, being built by another session right now:
`docs/plans/260827aa-delete-the-importer.md`. Its status line as of 2026-08-28: landings **C2–C7 are done and
...
serverless function does not have one that persists. Landing D of `260827aa-delete-the-importer.md` is the

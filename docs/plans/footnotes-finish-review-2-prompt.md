...
(`docs/plans/footnotes-finish-review-sol.md`). This is the fix. Please check the fix itself,
...
The regenerated scoped diff is `docs/plans/footnotes-finish.diff` (992 lines, was 799). You

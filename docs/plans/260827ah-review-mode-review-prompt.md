...
Read `docs/plans/260827ah-review-mode.md` in full. That is the thing under review.
...
- `docs/postmortems/260826h-chat-cache-automatic-breakpoint.md` — the caching bug that comment describes.
...
- `docs/plans/260826a-chat-mode.md` and `docs/project/chat-tools.md` — the two documents this plan builds on.

...
Follow-up to [260827am-glossary-read-latency.md](260827am-glossary-read-latency.md), which fixed one panel and
...
`docs/plans/260826e-postgres-storage-implementation.md`, and the stale `describeArticle` sentence in

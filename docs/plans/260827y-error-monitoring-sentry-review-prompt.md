...
`docs/plans/260827y-error-monitoring-sentry.md` first — that is the artefact under
...
`src/jobs.ts`, `docs/project/logging.md`, `docs/plans/260826p-error-boundary.md`.

## What I most want from you

**1. The privacy design — is it right, and is it enough?**
`docs/plans/260826p-error-boundary.md` records the same class of bug found four separate

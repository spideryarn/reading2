...
`docs/plans/260830aq-late-steps-read-the-store-review-sol.md`. That verdict was accepted in full. The scope
...
1. **`docs/plans/260831b-finish-the-database-move.md`** — the plan under review.
2. **`docs/plans/260830aq-late-steps-read-the-store-review-sol.md`** — your own earlier review. Check the plan
   has actually absorbed it rather than merely citing it.
3. **`docs/plans/260830aq-late-steps-read-the-store.md`** — the narrow predecessor, kept for the fault
   analysis and the block-id chain.
4. **`docs/plans/260827aa-delete-the-importer.md`** — the original migration plan and the authority on *why*.

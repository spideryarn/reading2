...
**The plan:** `docs/plans/260831b-finish-the-database-move.md` § Stage 2, which I updated as I went.
...
- **`src/pipeline.ts` contains a whole feature removal that is not mine.** Another session deleted
  the `summary` stage on Greg's instruction (`docs/plans/260831s-gist-only-summaries.md`), taking it out of

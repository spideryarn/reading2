...
article stuffed in the context window"*, and [chat-mode.md § Say the awkward thing
first](chat-mode.md#say-the-awkward-thing-first) is a long apology for building one anyway. Review
...
- A request whose `kind` contradicts an existing thread is a **409**, the same shape and reason as
  ...
  [chat-mode.md § the race a retry created](chat-mode.md) records.
...
[chat-cache-automatic-breakpoint.md](../postmortems/chat-cache-automatic-breakpoint.md), which cost
exactly that. So:
...
`docs/plans/review-mode-review-sol.md`, GPT-5.6 Sol, 2026-08-27. Verdict on the first draft:
...
`docs/plans/review-mode-code-review-sol.md`, GPT-5.6 Sol, 2026-08-28. Verdict again **NO-SHIP**, and
...
- [chat-mode.md](chat-mode.md) — the mode band, the citation contract, the panel this reuses

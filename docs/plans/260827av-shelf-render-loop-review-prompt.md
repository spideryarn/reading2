...
6. **Is the postmortem's causal account right?** `docs/postmortems/260827e-shelf-render-loop.md`. Correct
...
`docs/postmortems/260827e-shelf-render-loop.md`, `docs/plans/shelf-render-loop-scoped.diff`.

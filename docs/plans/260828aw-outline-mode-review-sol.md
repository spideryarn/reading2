...
The plan says to pass empty `closed`/`opened` sets ([260828aw-outline-mode.md:234](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/260828aw-outline-mode.md:234)). But selective expansion requires:
...
The claimed blast radius—“one row growing” ([260828aw-outline-mode.md:184](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/260828aw-outline-mode.md:184))—omits three kinds of motion:
...
- `docs/plans/260828ay-spine-rail.md` does not exist in this checkout, so its interaction and proposed `BandCard` contract cannot be reviewed. `BandCard` is currently private and coupled to the spine’s `Band`/`OutlineEntry` shape ([Spine.tsx:671](/Users/greg/Dropbox/dev/experim/spideryarn2/src/web/Spine.tsx:671)).

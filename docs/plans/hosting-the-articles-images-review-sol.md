...
6. **Several traps need changing.**
   ...
   - Trap 2 is right, including service-role enforcement. The postmortem has direct container evidence of the `415` ([evidence](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/postmortems/the-config-file-is-not-the-bucket.md:37)). However, [`blobs-supabase.ts`](/Users/greg/Dropbox/dev/experim/spideryarn2/src/store/blobs-supabase.ts:29) still states the opposite and must be corrected.

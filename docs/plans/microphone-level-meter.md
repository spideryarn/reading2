...
([review](microphone-level-meter-review-sol.md)) and again as built
([code review](microphone-level-meter-code-review-sol.md)); the plan review found two blockers that
changed the design substantially, and the record of that is below rather than quietly rewritten out.

Background on the feature: [reader-profile.md § The microphone](reader-profile.md#the-microphone) is
...
([code review](microphone-level-meter-code-review-sol.md)), which is the review that matters more —
...
- **Not moving to OpenRouter transcription.** The trade-off in
  [reader-profile.md § The microphone](reader-profile.md#the-microphone) has not changed, and nothing

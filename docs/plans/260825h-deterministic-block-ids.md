...
([260825f-postgres-migration.md § Block ids are only unique within an article](260825f-postgres-migration.md#block-ids-are-only-unique-within-an-article)).
...
on disk anyway
([260825f-postgres-migration.md](260825f-postgres-migration.md)). Three mechanisms to explain, for one recovery case.
...
[260825f-postgres-migration.md](260825f-postgres-migration.md), the "lose the file, lose the ids" risk changes shape
...
- [260825f-postgres-migration.md](260825f-postgres-migration.md) — the composite primary key, and the collision table

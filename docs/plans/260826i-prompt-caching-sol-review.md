...
6. **Should-fix — the quality gate remains unfinished.**
   ...
   The plan admits that the article-first reorder has not been evaluated (`docs/plans/260826g-prompt-caching.md:460`). This reorder changes model input semantics, not just transport.

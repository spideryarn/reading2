...
- `docs/plans/260827ai-public-read-only-access.md` — **the plan**. Assume its eight decisions are settled;
  Greg made them and they are not up for relitigation.
- `docs/plans/260827ai-public-read-only-access-review-sol.md` — your own previous review, for context on what

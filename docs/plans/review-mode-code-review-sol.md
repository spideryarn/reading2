...
The plan also explicitly says every answer shows its stance tag ([review-mode.md](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/review-mode.md:631)). No such rendering exists.

...
Your fifth review (`docs/plans/260829a-footnotes-finish-review-5-sol.md`) found the one thing five rounds
...
`docs/plans/260829h-footnotes-final.diff` (537 lines).

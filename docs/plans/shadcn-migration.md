...
[original-version.md § Already lifted](../project/original-version.md#already-lifted-into-this-repo).
...
|---|---|---|
| [original-version.md § Deliberately not lifted](../project/original-version.md#deliberately-not-lifted) | *"**shadcn/ui, Radix, Tailwind v4, Phosphor.** … Adopting Tailwind later is fine; inheriting a component library now is not."* | Adopting both. The "later" clause is being cashed in; the component-library half is a straight reversal. |
...
[original-version.md § Brand facts](../project/original-version.md#brand-facts-now-load-bearing)
...
| [original-version.md § Deliberately not lifted](../project/original-version.md#deliberately-not-lifted) | **The direct reversal.** Move shadcn/Radix/Tailwind into [§ Already lifted](../project/original-version.md#already-lifted-into-this-repo), and say what changed and when. Keep Phosphor where it is. |

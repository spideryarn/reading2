...
Your own review is at `docs/plans/public-read-only-stage1b-review-sol.md` — read it first, then the
current code at HEAD. `docs/plans/public-read-only-access.md` is the plan; Greg's eight decisions are

...
1. `docs/plans/delete-the-importer.md` — the whole thing. § Where it stands, § What this has taught
   us, and § The build order for C are new.
2. `docs/plans/artifacts-pg-shape-sol.md` — your own previous round, now folded in. Check I folded it

...
- The postmortem says “Three” bucket manifests and then lists four at [`260831e-a-write-path-with-no-reader.md`](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/postmortems/260831e-a-write-path-with-no-reader.md:82).

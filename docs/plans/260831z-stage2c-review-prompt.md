...
**The plan:** `docs/plans/260831b-finish-the-database-move.md` § Stage 2c.
...
`ArtifactKind` for bytes. Both this plan and `docs/plans/260827j-transactional-stage-runner.md` said so.
...
`docs/postmortems/260831e-a-write-path-with-no-reader.md` (appended to the diff) has both probes verbatim and

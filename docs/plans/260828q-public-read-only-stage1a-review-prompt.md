...
1. `docs/plans/260827ai-public-read-only-access.md` — the plan. Its eight decisions are Greg's and settled.
2. `docs/plans/260828h-public-read-only-stage1-input-sol.md` — **your own design input from this morning.**

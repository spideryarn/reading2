...
1. `docs/plans/public-read-only-access.md` — the plan. Greg's eight decisions are settled.
2. `docs/plans/public-read-only-stage1-input-sol.md` — your own design input. **Answer 8 is about
   ...
   discharges that.
3. `docs/plans/public-read-only-stage1a-review-sol.md` — your review of the server half.

...
| **A cross-family review** | **done** — GPT Sol, and it found three high-severity problems including one that would have leaked an OAuth code to a stranger's server. [§ what it changed](#the-cross-family-review-and-what-it-changed); full text in [260826w-auth-supabase-review-sol.md](260826w-auth-supabase-review-sol.md). |

The provider argument is over — [auth.md](../project/auth.md) decided Supabase Auth on 2026-08-25,
and [260825a-auth-options.md](../research/260825a-auth-options.md) is the survey behind it. This document is the
...
[260825d-deploy-and-repo-move.md § The beta gate](260825d-deploy-and-repo-move.md#the-beta-gate): *"`handleApi`
...
**Check that mailbox first.** [260825d-deploy-and-repo-move.md](260825d-deploy-and-repo-move.md#about-that-email-address)
...
- **`@supabase/auth-ui-react` is dead.** Unmaintained since February 2024; the
  ...
  again — the same shape as Lucia in [260825a-auth-options.md](../research/260825a-auth-options.md).
...
reasoning [260825a-shadcn-migration.md](260825a-shadcn-migration.md) used to reject `Dialog` and `Sheet`.
...
The full answer is kept at `docs/plans/260826w-auth-supabase-review-sol.md`. **Every finding below was
...
[260825a-auth-options.md § The line of schema that decided it](../research/260825a-auth-options.md).
...
- [260825a-auth-options.md](../research/260825a-auth-options.md) — why Supabase Auth, and the eleven things it beat
- [260825d-deploy-and-repo-move.md § The beta gate](260825d-deploy-and-repo-move.md#the-beta-gate) — what the gate

...
[GPT Sol's review of this plan](260827am-glossary-read-latency-review-sol.md), which returned *not ready to
...
- **`reset()` in production.** It already answers **501**: deleting a glossary under `postgres`
  ...
  of [260826e-postgres-storage-implementation.md](260826e-postgres-storage-implementation.md) owns the decision

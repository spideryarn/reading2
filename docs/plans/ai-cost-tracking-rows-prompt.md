...
- `docs/plans/ai-cost-tracking-review-sol.md` — the design review, before any code
- `docs/plans/ai-cost-tracking-code-review-sol.md` — the code review, which opened "Not ready to
...
- `docs/plans/ai-cost-tracking.md` — the plan. §"What gets built, and in what order" (line ~956) has

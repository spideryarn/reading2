...
`docs/plans/ai-cost-tracking-ledger-review-sol.md`, and every P1 you raised is fixed and committed
(`4379481`). This is the **next** piece of work, at plan stage, and I want your input before I build
it rather than after.

The plan is `docs/plans/ai-spend-outside-the-gateway.md`, inlined in full below, followed by the
...
[ai-cost-tracking.md](ai-cost-tracking.md), which built the ledger and then said, on every single
run of the report:
...
[Greg's open question 4](ai-cost-tracking.md#questions-for-greg): *"Do the evals count? They would
...
- [ai-cost-tracking.md](ai-cost-tracking.md) — the ledger this depends on

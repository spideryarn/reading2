...
You reviewed the **plan** for this a few hours ago (`docs/plans/260827z-admin-page-review-sol.md`). This is
...
**Read `docs/plans/260827z-admin-page.md` first.** Its § Who is the admin, § Tests and § The fence around

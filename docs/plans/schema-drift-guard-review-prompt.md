...
Read `docs/plans/schema-drift-guard.md` — that is the plan. Also worth reading:
...
- `docs/postmortems/unguarded-job-store-and-the-migration-that-migrated-the-laptop.md` — the

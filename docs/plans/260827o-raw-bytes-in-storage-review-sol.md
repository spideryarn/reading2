...
The sentence “at a name nobody will mint again” is backwards: content addressing guarantees that the same document will mint that name again. See `docs/plans/260827o-raw-bytes-in-storage.md:109-117`.

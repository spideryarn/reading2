...
Read `docs/plans/260828c-library-read-latency.md` in full. That is the thing under review.

It is a follow-up to `docs/plans/260827am-glossary-read-latency.md`, which you reviewed twice (the plan and
the built code) — `docs/plans/260827am-glossary-read-latency-review-sol.md` and
`docs/plans/260827am-glossary-read-latency-code-review-sol.md` are your own earlier findings, and that plan's

...
[260825f-postgres-migration.md § "Data" runs server-side only](260825f-postgres-migration.md) is explicit that the
...
[the Drizzle decision](260825f-postgres-migration.md) existed to delete. *"That is the tail wagging the
...
[260827r-offline-reading-slices-review-sol.md](260827r-offline-reading-slices-review-sol.md), on the sliced plan

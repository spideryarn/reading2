...
- `docs/plans/260827am-glossary-read-latency-code-review-3-sol.md` — your last review.
...
- `docs/plans/260827am-glossary-read-latency.md` — the plan.
- The live files.
...
3. **`pg.ts`** — the orphaned "everything except raw bytes" docblock is gone; its 23.89 MB
   measurement is carried into the policy's own docblock, and the `260827o-raw-bytes-in-storage.md` note

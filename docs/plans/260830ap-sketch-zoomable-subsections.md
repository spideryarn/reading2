...
([the prompt](260830ap-sketch-zoomable-subsections-review-prompt.md),
[the answer](260830ap-sketch-zoomable-subsections-review-sol.md)). Its verdict was **do
...
([prompt](260830ap-sketch-zoomable-subsections-code-review-prompt.md),
[answer](260830ap-sketch-zoomable-subsections-code-review-sol.md)) and the verdict was
...
- **A zoomable region has never been seen beside a non-zoomable one.** The
  ...
  ([260830j-sketch-diagram.md § The door the model forgot to fit](260830j-sketch-diagram.md#the-door-the-model-forgot-to-fit)

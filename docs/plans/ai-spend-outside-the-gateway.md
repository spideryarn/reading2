...
- [ai-spend-outside-the-gateway-sol.md](ai-spend-outside-the-gateway-sol.md) — GPT Sol's input on the
  plan, including the two premises of mine it corrected
- [ai-spend-outside-the-gateway-code-review-sol.md](ai-spend-outside-the-gateway-code-review-sol.md)
  and [-2-sol.md](ai-spend-outside-the-gateway-code-review-2-sol.md) — the two NO-SHIPs

...
The [current model](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/timeline-mode.md:157) also has no field backing the hard/soft edge distinction its drawing claims to show.
...
The plan is repeating the exact sequencing mistake that [Ideas corrected](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/ideas-mode.md:830).

...
[GPT Sol's review](260827h-durable-queue-and-uploads-review-sol.md) returned **NO-SHIP** on it, saying the
...
[260826e-postgres-storage-implementation.md § What happens next](260826e-postgres-storage-implementation.md#what-happens-next-in-order)
...
- **`work_key text not null`** — an immutable hash over the canonical ordered `{step, force}` list
  ...
  identity already includes guidance, and `260825f-postgres-migration.md` omitted it; profile joins it for
...
artefact writes when [step 11 half B stage 5](260826e-postgres-storage-implementation.md#what-happens-next-in-order)
...
> three additions above. [The first](260827m-durable-queue-code-review-sol.md) returned NO-SHIP with nine
> findings, four critical; [the second](260827n-durable-queue-fixes-review-sol.md) reviewed the fixes and
...
what [260827j-transactional-stage-runner.md](260827j-transactional-stage-runner.md) § D grows a transaction around.*
...
- [260827h-durable-queue-and-uploads-review-sol.md](260827h-durable-queue-and-uploads-review-sol.md) — the review that
  returned NO-SHIP on the first draft, and the source of most of the corrections above
- [260826q-job-queue-rethink.md](260826q-job-queue-rethink.md) — why browser-driven advance, and the three things that
  survive from the design it replaced
- [260826e-postgres-storage-implementation.md § What happens next](260826e-postgres-storage-implementation.md#what-happens-next-in-order) — the ordering this plan had inverted
- [260826u-pdf-upload-and-storage.md](260826u-pdf-upload-and-storage.md) — the upload flow this unblocks, and does not finish
- [ingest-queue.md](../project/ingest-queue.md) · [260826s-ingest-resume.md](260826s-ingest-resume.md) · [silent-success.md](../reusable/silent-success.md)

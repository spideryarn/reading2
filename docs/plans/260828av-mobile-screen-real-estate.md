...
Follows [260827t-mobile-reading-view.md](260827t-mobile-reading-view.md), which took the *width* back on a phone and
...
([260828av-mobile-screen-real-estate-code-review-sol.md](260828av-mobile-screen-real-estate-code-review-sol.md)),
...
- **No mobile layout.** Everything here is a rule the desktop already follows, followed further —
  the standing rule from [260827t-mobile-reading-view.md](260827t-mobile-reading-view.md). There is still no second

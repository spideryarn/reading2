...
`docs/plans/delete-the-importer.md` (NO-SHIP, eleven findings, ten folded in). This is the landing
...
7. `docs/plans/transactional-stage-runner.md` § C and § D — what the coordinator is supposed to do.
8. `docs/plans/delete-the-importer.md` § C — the ten traps I have already written down.
...
parity claim, which this repo produced twice yesterday (`docs/postmortems/toc-status-never-checked.md`).

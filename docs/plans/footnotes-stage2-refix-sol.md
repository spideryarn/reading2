...
Deferring the order-dependent suffix is still reasonable for stage 2 ([footnotes.md:701](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/footnotes.md:701)). It must become a stage-3 exit criterion before `noteId` backs persisted reader state; then wrong-occurrence reassignment becomes unacceptable.

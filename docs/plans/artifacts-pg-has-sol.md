...
`raw_filename` is the original uploaded filename, not `RawManifest.file`. The latter is an internal name derived exactly from kind: `html → raw.html`, `pdf → raw.pdf` ([delete-the-importer.md](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/delete-the-importer.md:329), [fetch.ts](/Users/greg/Dropbox/dev/experim/spideryarn2/src/fetch.ts:93)).

...
`docs/plans/footnotes-stage2-review-sol.md`. All three were accepted and fixed. `src/notes.ts` has
...
Read `src/notes.ts`, `tests/notes-canonical.test.ts`, and `docs/plans/footnotes.md`.

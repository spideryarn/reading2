...
- 202 tests pass across the nine affected files. Five files fail across the whole suite,
  all traced to peers' uncommitted work (`src/db/schema.ts`, `docs/plans/260826t-reader-profile.md`,
...
+   (docs/plans/260830o-steer-becomes-the-profile.md). Nothing writes one now; every

...
The **eleventh** mode in the band between the spine and the prose, beside [Ideas](260826ac-ideas-mode.md). It answers
...
[260831b-finish-the-database-move.md](260831b-finish-the-database-move.md) stage 1a/1b, and has **uncommitted edits
...
[260826ac-ideas-mode.md § Run the eval before building any of it](260826ac-ideas-mode.md#run-the-eval-before-building-any-of-it)
...
([260831i-timeline-mode-review-sol.md](260831i-timeline-mode-review-sol.md)). In parallel a spike ran the extraction
...
- [260826ac-ideas-mode.md](260826ac-ideas-mode.md) — the stage this is modelled on, and the source of the
...
- [260828aw-outline-mode.md](260828aw-outline-mode.md) — the most recent mode added, and the freshest account of what
  adding one costs.

...
This directly violates the repo’s primary ID contract and contradicts the plan’s instruction that Gwern and Wikipedia be “left alone” ([footnotes.md:594](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/footnotes.md:594)). The later renumbering fix does not repair IDs already lost during this migration.

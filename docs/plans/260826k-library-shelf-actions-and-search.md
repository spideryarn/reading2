...
of [260826e-postgres-storage-implementation.md](260826e-postgres-storage-implementation.md) are not started, and
...
([260826e-postgres-storage-implementation.md § step 5](260826e-postgres-storage-implementation.md)) must therefore
...
- **pgvector and embeddings.** `vector 0.8.2` is available locally but not enabled. Anthropic has no
  ...
  [260826e-postgres-search.md](../research/260826e-postgres-search.md).
...
8. Docs: rewrite [library.md](../project/library.md)'s card section, extend
   ...
   [260826e-postgres-storage-implementation.md](260826e-postgres-storage-implementation.md).

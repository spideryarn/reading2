...
| ToC | Reads blocks; writes labels, updated blocks and tree ([toc.ts:659](/Users/greg/Dropbox/dev/experim/spideryarn2/src/toc.ts:659), [toc.ts:826](/Users/greg/Dropbox/dev/experim/spideryarn2/src/toc.ts:826)) | Inputs are loud. Missing label checkpoints are **quiet** and repeat model work. |

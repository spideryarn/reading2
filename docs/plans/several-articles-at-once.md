...
[faster-ingest-and-concurrency.md](faster-ingest-and-concurrency.md), which was answering a narrower
...
[delete-the-importer.md](delete-the-importer.md) D2 onward, where the stages stop writing files.
...
[late-steps-read-the-store.md](late-steps-read-the-store.md). **Stage 2 waits for it.** Stage 1 does
...
[faster-ingest-and-concurrency.md](faster-ingest-and-concurrency.md) already has concurrency as its

...
`docs/plans/chat-client-architecture-review-sol.md`. This is a short, focused re-check — **only
...
3. Do the corrected claims in `docs/plans/chat-client-architecture.md` and the docstring of

...
Therefore the proposed manual command explains `data/wolfram-bugs/article.html` exactly. The repo’s plan records that the investigation rerun created that file ([260830am-faster-ingest-and-concurrency.md](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/260830am-faster-ingest-and-concurrency.md:860)). Deleting it with approval was correct; no manifest entry was warranted.

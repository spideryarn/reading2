...
You reviewed `docs/plans/260827o-raw-bytes-in-storage.md` earlier today and returned NO-SHIP with three
...
| `pg_net` is not POST-only | corrected in `docs/research/260827c-supabase-storage-vs-postgres.md` |

## Read these

1. `docs/plans/260827o-raw-bytes-in-storage.md` — the second draft. The thing under review.
2. `docs/plans/260827o-raw-bytes-in-storage-review-sol.md` — your first review, for what you already said.

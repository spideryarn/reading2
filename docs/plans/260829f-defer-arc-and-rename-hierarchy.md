...
review** —
`260829f-defer-arc-and-rename-hierarchy-sol.md`, verdict *"revise before building"*. Every finding below was
...
- **Refetch `/api/article/:slug`** when the job finishes. Simplest, no new route, but re-reads every
  ...
  cost `docs/plans/260827am-glossary-read-latency.md` was written about.

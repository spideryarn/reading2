...
`docs/plans/sketch-zoomable-subsections-review-sol.md`. Three of your blockers
were taken and the code below is the result; the fourth (#5, the mark) was
partly taken. `docs/plans/sketch-zoomable-subsections.md`
...
1. `docs/plans/sketch-zoomable-subsections.md` — the plan as it now stands.

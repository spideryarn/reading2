...
[GPT Sol's review](durable-artefacts-review-sol.md) returned NO-SHIP, and was right.
...
[GPT Sol's review](durable-artefacts-review-sol.md), asked for before anything was built, returned
...
[delete-the-importer.md](delete-the-importer.md)'s D-series.
...
[delete-the-importer.md](delete-the-importer.md). There is no smaller thing that gets there. That is

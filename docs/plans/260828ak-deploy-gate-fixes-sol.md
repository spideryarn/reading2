...
4. Later, replace laptop state with a small committed fixture corpus under `tests/fixtures/`. That debt is already acknowledged in [260827v-deploy-pipeline.md](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/260827v-deploy-pipeline.md:466). This likely does not require rewriting 14 tests independently; central fixture loaders can carry most of it.

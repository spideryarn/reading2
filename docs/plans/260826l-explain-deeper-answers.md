...
> [260826b-prompt-caching-anthropic.md § invalidation](../research/260826b-prompt-caching-anthropic.md) puts
...
- [prompt-caching.md](../project/prompt-caching.md) — why the deep instruction goes after the
  breakpoint
- [260826a-chat-mode.md](260826a-chat-mode.md) — the streaming machinery being borrowed

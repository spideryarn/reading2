...
[../research/260826a-pdf-parsing-options.md](../research/260826a-pdf-parsing-options.md). This file says what we're
...
[260825f-postgres-migration.md § raw.html is not raw](260825f-postgres-migration.md#the-schema): the `FetchedDocument`
...
sources: [research § C](../research/260826a-pdf-parsing-options.md#c-a-multimodal-model-reads-the-pages).
...
[research § second round](../research/260826a-pdf-parsing-options.md#second-round-2026-08-26):
...
LlamaParse at scale ([research](../research/260826a-pdf-parsing-options.md#silent-degradation-is-documented-in-production-not-theoretical)).
...
> [260826u-pdf-upload-and-storage.md](260826u-pdf-upload-and-storage.md), because uploads are what hand this parser
> to a stranger.
...
[the postmortem](../postmortems/260826d-block-id-matching-non-latin.md).
...
[260825f-postgres-migration.md](260825f-postgres-migration.md) revision rows need the columns. Define them before
...
> **Worked out in full in [260826u-pdf-upload-and-storage.md](260826u-pdf-upload-and-storage.md)** (2026-08-26) —
...
0. ~~**Fix stage 3's paragraph matcher**~~ — **done, 2026-08-26**
   ([postmortem](../postmortems/260826d-block-id-matching-non-latin.md#what-landed)). A Unicode-aware fold,
...
7. Upload last — the store seam, then the file picker, then the pipeline's URL assumptions. Not
   ...
   [260826u-pdf-upload-and-storage.md](260826u-pdf-upload-and-storage.md), which adds the object store underneath
...
[the research](../research/260826a-pdf-parsing-options.md) were never about *this* model.
...
3. **A second vendor — yes, whoever reads best wins.** This *reverses* the plan's earlier default of
   ...
   **Researched, and it does**: OpenRouter's `native` PDF engine reaches Gemini and Claude under the
   ...
   [research § second round](../research/260826a-pdf-parsing-options.md#second-round-2026-08-26); what it
...
4. **Non-Latin id matching** — not answered directly; handed to a background Opus subagent to
   ...
   [the postmortem](../postmortems/260826d-block-id-matching-non-latin.md), and it changes the answer: the
...
[260827a-pdfjs-dommatrix-serverless.md](../postmortems/260827a-pdfjs-dommatrix-serverless.md) is the write-up.
...
- **All four earlier observations came from HTML articles with headings** — and "four observations"
  ...
  postmortem** ([260830a-the-article-with-one-heading.md](../postmortems/260830a-the-article-with-one-heading.md)):
...
> **Decided 2026-08-30.** Greg ruled that a failed structure call must stop costing the whole
> article, and that tiling gaps stop being fatal:
>
> > for now, we should allow gaps. It's not ideal, but it's not the end of the world, and better
> > than things failing fatally. Perhaps in future, it should trigger a re-run of the LLM, where we
> > feed in the previous output, with information about the gaps and ask it to adjust.
> >
> > — Greg, 2026-08-30
>
...
- [../research/260826a-pdf-parsing-options.md](../research/260826a-pdf-parsing-options.md) — the options and the evidence
...
- [260825f-postgres-migration.md](260825f-postgres-migration.md) — where uploaded bytes live once there is a database
- [260825d-deploy-and-repo-move.md](260825d-deploy-and-repo-move.md) — the Vercel constraints, including the body limit

...
- `docs/plans/transactional-stage-runner.md` — the plan under review
- `docs/plans/durable-queue-and-uploads.md` — the queue/upload half. § 7 is the A/B question whose
  answer this plan implements; § 8 is the wiring this plan says goes first
- `docs/plans/durable-queue-and-uploads-review-sol.md` — your own earlier review, whose ordering this

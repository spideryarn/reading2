...
Scoped diff: `docs/plans/footnotes-stage3b-v3.diff` (`src/blocks.ts`, `src/notes.ts`). Tests:
...
`docs/plans/footnotes.md` § "Stage 3b, as it actually landed"? If you still think the anchor is

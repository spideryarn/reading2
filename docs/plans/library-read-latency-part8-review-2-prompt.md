...
`docs/plans/library-read-latency-part8-review-sol.md`. Both findings were right and both are fixed.
...
- `docs/plans/library-read-latency.md` § 8 — rewritten for the corrected shape, with the mutation
  table above.

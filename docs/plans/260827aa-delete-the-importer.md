...
**[GPT Sol's input round](260827aa-delete-the-importer-review-sol.md) returned NO-SHIP on its first draft**
...
**Stopped after D1b, deliberately, in favour of [260830d-v1-imports-on-vercel.md](260830d-v1-imports-on-vercel.md).**
...
The work is scoped in [260830aq-late-steps-read-the-store.md](260830aq-late-steps-read-the-store.md), with a red repro
at `tests/late-step-on-a-cold-instance.test.ts` and a GPT Sol review
([260830aq-late-steps-read-the-store-review-sol.md](260830aq-late-steps-read-the-store-review-sol.md)) that returned
...
from this plan entirely until 2026-08-29. And the reviews are the map: `260827aa-delete-the-importer-d1b-sol.md`
...
| `2a2cf7f` | The [postmortem](../postmortems/260827d-toc-status-never-checked.md) for the first, which found the part I had not. | |
...
| `056c46e` + `4038291` | **A live bug with nothing to do with this plan**, and the guard for its class. | [260828a-the-config-file-is-not-the-bucket.md](../postmortems/260828a-the-config-file-is-not-the-bucket.md). |
...
| `a0b2c14` | **C7 — the three suites off the importer**, the corpus wiped so the comparison means something, and a permanent data-loss bug in `db:export` found by doing the review's homework. | § C7, and [the postmortem](../postmortems/260828c-export-never-wrote-the-readers-purpose.md). |
...
([260828at-html-ingest-var-data-sol.md](260828at-html-ingest-var-data-sol.md)): three functions on the **live enqueue
...
[260828a-the-config-file-is-not-the-bucket.md](../postmortems/260828a-the-config-file-is-not-the-bucket.md) has both
...
[postmortem](../postmortems/260827d-toc-status-never-checked.md) has the general form: when *"is this row
...
[The third Sol round](260827aa-delete-the-importer-review-2-sol.md) read this document *plus* the five commits
...
[The fourth Sol round](260827au-c1-c2-code-review-sol.md) read C1 and C2 **as built** and returned NO-SHIP.
...
[The fifth Sol round](260828b-artifacts-pg-has-sol.md) was asked one question: is the `toc` case in C4 wrong?
...
[The sixth Sol round](260828e-landing-c-code-review-sol.md) read C3 through C6 as built and returned
...
**1. The verifying backfill.** [260827o-raw-bytes-in-storage.md § The backfill can put the wrong bytes under
a hash](260827o-raw-bytes-in-storage.md) is the most dangerous page in that plan, and restating why is what
...
[260827j-transactional-stage-runner.md § What has to be true](260827j-transactional-stage-runner.md), one set of
...
Unchanged from [260827j-transactional-stage-runner.md](260827j-transactional-stage-runner.md) except where marked.
...
- **Moving to a row fixes a corruption class for free**, because a row cannot be half-written. That
  ...
  [260828e-pdf-chunk-cache-corrupt-entry.md](../postmortems/260828e-pdf-chunk-cache-corrupt-entry.md), where a
...
#### What the code review found — [260829e-b3-checkpoints-sol.md](260829e-b3-checkpoints-sol.md)
...
[260828e-pdf-chunk-cache-corrupt-entry.md](../postmortems/260828e-pdf-chunk-cache-corrupt-entry.md), is about a
...
worth recording as a datum rather than a chore: 260827w-schema-drift-guard.md's mechanism caught a real
...
[A second input round](260827ac-artifacts-pg-shape-sol.md) put three questions to Sol — how the store is
...
#### What the review of the loader changed — [260828m-c7-fixture-loader-sol.md](260828m-c7-fixture-loader-sol.md)
...
#### What the review of the three suites changed — [260828ab-c7-suites-sol.md](260828ab-c7-suites-sol.md)
...
[The postmortem](../postmortems/260828c-export-never-wrote-the-readers-purpose.md) has the root cause — a
...
Not in any earlier draft. I found one of these; [the review](260828an-blocks-carry-forward-sol.md) found the
...
2. **`db:export` fails closed** — § `db:export` must fail closed. It is the rollback tool, and on
   ...
   ([the postmortem](../postmortems/260828c-export-never-wrote-the-readers-purpose.md)). A backup nobody has
...
#### What the plan review changed — [260827aa-delete-the-importer-d-plan-sol.md](260827aa-delete-the-importer-d-plan-sol.md)
...
>
> — [260826e-postgres-storage-implementation.md](260826e-postgres-storage-implementation.md), 2026-08-26
...
#### What D1a's code review changed — [260827aa-delete-the-importer-d1a-sol.md](260827aa-delete-the-importer-d1a-sol.md)
...
> [260831o-checkpoint-reclamation.md](260831o-checkpoint-reclamation.md).
>
...
#### What the D1 design review changed — [260827aa-delete-the-importer-d1-design-sol.md](260827aa-delete-the-importer-d1-design-sol.md)
...
#### What D1b's design review changed — [260827aa-delete-the-importer-d1b-design-sol.md](260827aa-delete-the-importer-d1b-design-sol.md)
...
#### What D1b's code review changed — [260827aa-delete-the-importer-d1b-sol.md](260827aa-delete-the-importer-d1b-sol.md)
...
#### What D0's code review found — [260827aa-delete-the-importer-d0-sol.md](260827aa-delete-the-importer-d0-sol.md)
...
15. **`blocks`, `glossary` and `ideas` keep their ids on a *second* run against unchanged text**,
    ...
    [260827j-transactional-stage-runner.md](260827j-transactional-stage-runner.md) item 8, runs the pipeline with
...
`htmlFile` ([260827j-transactional-stage-runner.md](260827j-transactional-stage-runner.md)), so the code that reads
...
- [260827aa-delete-the-importer-review-sol.md](260827aa-delete-the-importer-review-sol.md) — the NO-SHIP input round on
  this document's first draft, and the source of most of what is above
- [260828an-blocks-carry-forward-sol.md](260828an-blocks-carry-forward-sol.md) — NO-SHIP on five of seven, and the
  round that found glossary and ideas carrying identity in a file too
  ([the prompt](260828am-blocks-carry-forward-prompt.md))
- [260827j-transactional-stage-runner.md](260827j-transactional-stage-runner.md) — the landings this re-sequences
- [260827o-raw-bytes-in-storage.md](260827o-raw-bytes-in-storage.md) — where `storeRawSource`, `raw_sources` and the
  project-pair check come from, and whose backfill this deletes
- [260827o-raw-bytes-in-storage-input-3-sol.md](260827o-raw-bytes-in-storage-input-3-sol.md) — the round that found
  the publication gate written but not built
- [260827h-durable-queue-and-uploads.md](260827h-durable-queue-and-uploads.md) · [260825f-postgres-migration.md](260825f-postgres-migration.md)

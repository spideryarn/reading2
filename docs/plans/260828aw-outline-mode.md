...
being narrowed and its hover cards enriched in parallel: [260828ay-spine-rail.md](260828ay-spine-rail.md).)
...
- The hover card should be the spine's `BandCard` or whatever [260828ay-spine-rail.md](260828ay-spine-rail.md) leaves
...
- **Hover gives the full card** for any row whose text is clamped, grouped so running down the list
  ...
  **One shared "which card is open" state across many triggers is a bug, and it has already been
  ...
  [260828ay-spine-rail.md](260828ay-spine-rail.md) and `tests/spine-hover.test.tsx`.
...
GPT Sol, gpt-5.6-sol, 2026-08-28 — `260828aw-outline-mode-review-sol.md`, from
`260828aw-outline-mode-review-prompt.md`. Verdict: **revise before building**, with three blocking findings.
...
[The prompt](260828aw-outline-mode-fading-review-prompt.md) and
[the answer](260828aw-outline-mode-fading-sol.md), the usual way
...
- [260828ay-spine-rail.md](260828ay-spine-rail.md) — the rail, narrowed and given richer hover cards, in parallel
- [silent-success.md](../reusable/silent-success.md) — most of the traps named above are instances

## The code review

GPT Sol, gpt-5.6-sol, 2026-08-28 — `260828aw-outline-mode-code-review-sol.md`, from
`260828aw-outline-mode-code-review-prompt.md`. Verdict: **revise before commit**, and it was right to. Four

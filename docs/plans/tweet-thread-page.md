...
[metadata-page.md § The routing change](metadata-page.md#the-routing-change-a-shared-prerequisite).
...
[metadata-page.md](metadata-page.md) has to solve for the tree and the arc, and the same answer.
...
- [metadata-page.md](metadata-page.md) — the other page, and the routing change both need
- [bottom-bar.md](bottom-bar.md) — the bar this page's button lives in

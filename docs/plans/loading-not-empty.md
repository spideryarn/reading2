...
The code went to GPT Sol — `loading-not-empty-review-prompt.md`, answer in
`loading-not-empty-review-sol.md`. Five findings, all taken:
...
The fixes went back to GPT Sol — `loading-not-empty-review-2-prompt.md`, answer in
`loading-not-empty-review-2-sol.md`. One must-fix, two should-fixes, a note; all taken.

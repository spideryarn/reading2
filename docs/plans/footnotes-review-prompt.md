...
Read `/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/footnotes.md` — the full plan for
...
`docs/plans/footnotes-sol.md` and the prompt that produced it is `docs/plans/footnotes-prompt.md`.

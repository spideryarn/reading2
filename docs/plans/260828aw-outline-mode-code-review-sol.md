...
- [260828aw-outline-mode.md](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/260828aw-outline-mode.md:3) still says “planned, not built,” and its review table still claims `focusRow` is exact.

...
This is the third item on [260826ae-auth-ui-and-production.md § What Greg has to do](260826ae-auth-ui-and-production.md#what-greg-has-to-do),
...
**Reviewed by [GPT Sol](260827i-google-sign-in-production-review-sol.md)** before any of it was built; the
...
Same clicks as [§ 1](260826ae-auth-ui-and-production.md#1-google-cloud-console-add-one-redirect-uri), and
...
shipped exactly that bug once — [§ The check that could not fail](260826w-auth-supabase.md#the-check-that-could-not-fail).

...
You reviewed the **plan** for this earlier — `docs/plans/260827w-schema-drift-guard-review-sol.md` has your
...
`docs/plans/260827w-schema-drift-guard.md` records what was built and what was deliberately deferred.

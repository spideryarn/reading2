...
Therefore the [comment](/Users/greg/Dropbox/dev/experim/spideryarn2/src/web/useChat.ts:653), [test docstring](/Users/greg/Dropbox/dev/experim/spideryarn2/tests/chat-error-scope.test.ts:23), and [write-up](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/chat-client-architecture.md:135) must describe this as defensive hook-level behavior, not a reader-visible cross-article race.

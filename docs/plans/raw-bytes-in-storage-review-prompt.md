...
writable disk. The plan for the write path is `docs/plans/transactional-stage-runner.md`, which you
reviewed twice already (`docs/plans/transactional-stage-runner-review-sol.md`,
`docs/plans/durable-queue-code-review-sol.md`). Your third critical finding in the first of those was:
...
1. `docs/plans/raw-bytes-in-storage.md` — the proposal. This is the thing under review.
2. `docs/research/supabase-storage-vs-postgres.md` — the sourced facts behind it.
3. `docs/plans/transactional-stage-runner.md` — the plan it edits, especially landings B and C.

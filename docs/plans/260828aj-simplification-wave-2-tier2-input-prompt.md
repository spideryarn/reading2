...
Read [`docs/plans/260828aj-simplification-wave-2.md`](260828aj-simplification-wave-2.md), especially
`## Tier 2` and `## What not to do`. Tiers 0 and 1 are built, committed and already
reviewed by you (see `260828aj-simplification-wave-2-review-sol.md` and
`260828aj-simplification-wave-2-tier1-review-sol.md` — you were right about the `.env.local`

...
The full consultation is in [chat-client-architecture-sol.md](chat-client-architecture-sol.md); the
prompt it answered is in [chat-client-architecture-prompt.md](chat-client-architecture-prompt.md).
The review of the code built from it — which returned **do not ship**, and was right to — is in
[chat-client-architecture-review-sol.md](chat-client-architecture-review-sol.md).

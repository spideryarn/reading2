...
Calling the initial inventory “the diagnostic that tells us whether the premise holds” is therefore circular ([plan](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/260827ab-readability-repair-pass.md:154)). A lossy detector cannot establish the prevalence of failures it cannot represent.
...
Running repair arms on easy articles invokes each model. The regression measurement is essential, but not free ([plan](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/260827ab-readability-repair-pass.md:142)).

...
[`docs/plans/simplification-wave-2.md`](simplification-wave-2.md). The plan itself was reviewed by
you before anything was built ([`simplification-wave-2-review-sol.md`](simplification-wave-2-review-sol.md)),
and Tier 0 was reviewed after it was built
([`simplification-wave-2-code-review-sol.md`](simplification-wave-2-code-review-sol.md)). This is
...
7. **`JobStore`, deleted against a recorded decision.** `docs/plans/simplification-audit.md` A.2 says
...
- **`src/web/preview-colour.tsx`**, which the plan said to delete. Refused: `preview-colour.html` at
  ...
  made — `docs/plans/search-row-colour.md:315` records that the extension was not connected.

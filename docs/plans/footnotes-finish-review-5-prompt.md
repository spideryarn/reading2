...
Your fourth review (`docs/plans/footnotes-finish-review-4-sol.md`) returned BLOCK on three
...
`git show 6bc1021` is the whole change (35 files). `docs/plans/footnotes.md` has the write-up.

...
- The root’s term vector also includes every note because its range spans the apparatus: [graph.ts](/Users/greg/Dropbox/dev/experim/spideryarn2/src/web/graph.ts:334). The plan explicitly identified this consumer: [260828o-footnotes.md](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/plans/260828o-footnotes.md:280).

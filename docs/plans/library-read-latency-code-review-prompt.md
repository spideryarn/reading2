...
of the plan for this change is `docs/plans/library-read-latency-review-sol.md`, and every one of its
four must-fixes was verified and acted on. What follows is what got built.

## What to read

- `docs/plans/library-read-latency.md` — the plan, **rewritten after your review**. Its § "How each

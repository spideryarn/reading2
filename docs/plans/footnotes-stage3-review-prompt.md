...
([prompt](footnotes-stage345-upfront-prompt.md), [answer](footnotes-stage345-upfront-sol.md)). It is
...
Plus `docs/plans/footnotes.md` — the sections "Stage 3's input, measured before building it",

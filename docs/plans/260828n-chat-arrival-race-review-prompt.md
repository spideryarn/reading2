...
(`docs/plans/260826a-chat-mode.md § The box under the list, which saves the click`). An earlier review of
...
`docs/plans/260826a-chat-mode.md`, two new sections plus a corrected rationale on the composer's guard: the

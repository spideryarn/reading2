...
1. **`docs/plans/timeline-mode.md`** — the plan under review. Read it all.
...
4. **`docs/plans/ideas-mode.md`** and **`docs/project/ideas.md`** — the feature this is modelled on,
...
propose an eval, and `docs/plans/ideas-mode.md` has a section called "Run the eval before building any
of it". Should it?

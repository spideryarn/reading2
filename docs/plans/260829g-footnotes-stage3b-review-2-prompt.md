...
(`docs/plans/260829g-footnotes-stage3b-review-sol.md`). Both were real and both are now addressed, along
...
scoped diff is `docs/plans/260829o-footnotes-stage3b-v2.diff` (`src/blocks.ts` and `src/notes.ts`), the
tests are `tests/note-carry-over.test.ts` (25 of them), and the write-up is
`docs/plans/260828o-footnotes.md` § "Stage 3b, as it actually landed".

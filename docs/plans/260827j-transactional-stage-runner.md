...
This is the half [260827h-durable-queue-and-uploads.md § 7](260827h-durable-queue-and-uploads.md) put to Greg as a
...
[GPT Sol's review](260827j-transactional-stage-runner-review-sol.md) returned **NO-SHIP** on the first draft
...
**It was wired first anyway, on 2026-08-27** — [260827h-durable-queue-and-uploads.md § 8](260827h-durable-queue-and-uploads.md#8-the-wiring-built-2026-08-27).
...
that this contradicts [260827h-durable-queue-and-uploads.md](260827h-durable-queue-and-uploads.md)'s own requirement
...
- [260827h-durable-queue-and-uploads.md](260827h-durable-queue-and-uploads.md) — the queue and upload half, § 7 the
  A/B question this answers and § 8 the wiring that goes first
- [260827j-transactional-stage-runner-review-sol.md](260827j-transactional-stage-runner-review-sol.md) — the review
  ...
  written down
- [260827h-durable-queue-and-uploads-review-sol.md](260827h-durable-queue-and-uploads-review-sol.md) — the review of
  the queue half's *plan*, whose build order this document follows except in one place, and says why
- [260827m-durable-queue-code-review-sol.md](260827m-durable-queue-code-review-sol.md) and
  [260827n-durable-queue-fixes-review-sol.md](260827n-durable-queue-fixes-review-sol.md) — the reviews of the queue
...
- [260826e-postgres-storage-implementation.md](260826e-postgres-storage-implementation.md) — step 11 half B, of which
  this is stage 5
- [260825f-postgres-migration.md](260825f-postgres-migration.md) · [260826q-job-queue-rethink.md](260826q-job-queue-rethink.md) ·

...
([260828aj-simplification-wave-2-review-sol.md](260828aj-simplification-wave-2-review-sol.md)). Verdict: **revise
...
| **the Tier 1 review** | `b709d26` — [`260828aj-simplification-wave-2-tier1-review-sol.md`](260828aj-simplification-wave-2-tier1-review-sol.md). One medium finding: the `.env.local` gate accepted a call that runs *after* the spending. Fixed, and it then found `src/labels.ts` in the same shape. |
...
| **2.2** `stage-call.ts` | medium | [asked Sol](260828aj-simplification-wave-2-tier2-input-prompt.md) |
...
[prompt](260828aj-simplification-wave-2-tier2-input-prompt.md) ·
[answer](260828aj-simplification-wave-2-tier2-input-sol.md). **It narrowed all three and left none**, and the
...
[prompt](260828aj-simplification-wave-2-tier2-review-prompt.md) ·
[answer](260828aj-simplification-wave-2-tier2-review-sol.md) · fixed in `750cf87`. Verdict: **revise the 2.5
...
- ~~**`src/web/preview-colour.tsx`**~~ — **refused, 2026-08-28, and this is the interesting one.**
  ...
  **And the check is not done.** `docs/plans/260827l-search-row-colour.md:315` says the browser pass was
  ...
  - **`tests/doc-links.test.ts` would go red.** `260827l-search-row-colour.md:324` links the file as
...
- **`scratch-tok2.mts`** — **kept, and I had deleted it before the check came back.** Fourteen lines
  ...
  it is more specific than I realised: [260826h-toc-scaling.md § 61](260826h-toc-scaling.md) cites *"about 40 tokens
...
- **`rename-preview.html`** — not merely unused: **broken**. It loads
  ...
  [260828r-worktrees.md:57](260828r-worktrees.md) records `rename-preview.tsx` as a typecheck complaint back when it
  still existed.

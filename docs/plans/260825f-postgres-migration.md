...
This is the work [260825d-deploy-and-repo-move.md](260825d-deploy-and-repo-move.md#what-this-plan-needs-from-the-supabase-work)
...
| | Decision | Standing |
|---|---|---|
| **Auth** | Design for it, don't build it — tables carry an owner column, RLS deferred, no login UI of our own | **Settled elsewhere, and compatibly.** Greg has since told the deploy plan that auth *is* in scope as [a one-email beta gate](260825d-deploy-and-repo-move.md#the-beta-gate). See [§ Auth](#auth-the-gate-is-someone-elses-plan) |
...
| **Client** | ~~`supabase-js`, not Drizzle/Prisma~~ | **Reversed by Greg, 2026-08-25**, once he decided [the API layer, not RLS, is the security boundary](260825d-deploy-and-repo-move.md#rls-and-realtime-not-now). Now **Drizzle for all data, Supabase for Auth alone** — see [§ The client](#the-client-drizzle-for-data-supabase-for-auth) |
...
[the beta gate](260825d-deploy-and-repo-move.md#the-beta-gate), so it should be confirmed with
...
([260825a-auth-options.md](../research/260825a-auth-options.md)). Greg's answer, and the design, are in
[260825d-deploy-and-repo-move.md § The beta gate](260825d-deploy-and-repo-move.md#the-beta-gate): a hard-coded
...
- **RLS stays deferred, so the grants carry the whole weight.** [ingest is gated in the API layer](260825d-deploy-and-repo-move.md#rls-and-realtime-not-now),
...
[260825d-deploy-and-repo-move.md](260825d-deploy-and-repo-move.md) estimated for a full cloud-native rebuild —
...
[260825d-deploy-and-repo-move.md § What this plan needs from the Supabase work](260825d-deploy-and-repo-move.md#what-this-plan-needs-from-the-supabase-work)
...
3. **Auth, or a way to tell Greg from a stranger** — **shared.** The gate itself is that plan's
   ([§ The beta gate](260825d-deploy-and-repo-move.md#the-beta-gate)); this plan supplies the `owner_id`
...
- [ingest-queue.md § When this becomes Postgres](../project/ingest-queue.md#when-this-becomes-postgres)
  ...
  worked
- [260825d-deploy-and-repo-move.md](260825d-deploy-and-repo-move.md) — its Option 4 says "Postgres, a real queue,
...
2. ~~Mutations in production: closed, or a minimal gate?~~ **Answered** by
   [the beta gate](260825d-deploy-and-repo-move.md#the-beta-gate) — a one-email allowlist, now against an
...
- [260825d-deploy-and-repo-move.md](260825d-deploy-and-repo-move.md) — the plan waiting on this one

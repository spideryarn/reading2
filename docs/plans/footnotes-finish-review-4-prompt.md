...
Your third review (`docs/plans/footnotes-finish-review-3-sol.md`) confirmed the summary fix and
...
The regenerated scoped diff is `docs/plans/footnotes-finish.diff` (1615 lines). Three files

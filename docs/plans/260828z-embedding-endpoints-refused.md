...
([…-sol.md](260828z-embedding-endpoints-refused-sol.md)) corrected it in several places. The first two are
...
([…-code-review-sol.md](260828z-embedding-endpoints-refused-code-review-sol.md)), which is the review this
...
- [the postmortem](../postmortems/260828d-the-deployed-key-was-never-asked-to-do-anything.md) — the class of
  bug, rather than this instance of it.
- [copy.md](../project/copy.md) — the four kinds, and why `ours` mislabelled as `retry` is the
  expensive one.
- [260827g-embedding-scatter-diagrams.md](260827g-embedding-scatter-diagrams.md) — what Drift and Trail are.

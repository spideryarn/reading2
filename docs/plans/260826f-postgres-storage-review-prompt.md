...
>   --prompt-file docs/plans/260826f-postgres-storage-review-prompt.md \
...
> Drop the "read these first" list to `260826e-postgres-storage-implementation.md` alone, name the six source
...
- `docs/plans/260826e-postgres-storage-implementation.md` — my doing document. Progress table, decisions,
  what is deliberately not done. **Start here.**
- `docs/plans/260825f-postgres-migration.md` — the older design doc: the schema, the seven decisions, and a

...
You reviewed this plan twice before it was fit to build (`docs/plans/260828v-chat-operation-model-sol.md`,
...
- `docs/plans/260828v-chat-operation-model.md`, especially § *What stage 1 actually did*, which records four

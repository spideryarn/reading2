...
- `docs/plans/260827x-dictation-two-pass.md` — the plan, now updated, with a section at the bottom saying
  what your review changed and the one thing that was deliberately not taken.
- `docs/plans/260827x-dictation-two-pass-review-sol.md` — your own nine findings, for reference.

...
- [First review](260827o-raw-bytes-in-storage-review-sol.md): three criticals. The sweeper races a commit; a
  hash is not a key; the backfill can put the wrong bytes under a hash.
- [Second review](260827o-raw-bytes-in-storage-review-2-sol.md), on the draft that answered the first: two
...
forward. [260826u-pdf-upload-and-storage.md § Appendix](260826u-pdf-upload-and-storage.md) recommends exactly this —
...
[260827c-supabase-storage-vs-postgres.md](../research/260827c-supabase-storage-vs-postgres.md); the spike numbers are
...
[the review prompt](260827o-raw-bytes-in-storage-review-prompt.md), deleted after running):
...
1. **`fetch` puts its bytes in the blob store — done, 2026-08-27** — at
   ...
   **Registering the row is deliberately not here.** Pipeline steps do not write to Postgres at all
   ...
   live-write pipeline arrives with [260827j-transactional-stage-runner.md](260827j-transactional-stage-runner.md).
...
last is the single fenced commit [260827j-transactional-stage-runner.md](260827j-transactional-stage-runner.md)
...
[the research doc](../research/260827c-supabase-storage-vs-postgres.md).

## See also

- [260827o-raw-bytes-in-storage-review-sol.md](260827o-raw-bytes-in-storage-review-sol.md) — the review, in full
- [260827c-supabase-storage-vs-postgres.md](../research/260827c-supabase-storage-vs-postgres.md) — the sourced facts
- [260827j-transactional-stage-runner.md](260827j-transactional-stage-runner.md) — the plan this edits
- [260826u-pdf-upload-and-storage.md](260826u-pdf-upload-and-storage.md) — the blob seam, and the appendix that

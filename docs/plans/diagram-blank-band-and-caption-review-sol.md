...
- [the postmortem:58](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/postmortems/the-scroller-that-mounted-after-the-measure.md:58) says jsdom cannot see the bug, but the new jsdom test does reproduce it. The missing piece was the transition scenario, not jsdom itself.
- [the postmortem:69](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/postmortems/the-scroller-that-mounted-after-the-measure.md:69) says the ref is called with `null`; the revised implementation returns a cleanup and therefore is not.
- [the postmortem:79](/Users/greg/Dropbox/dev/experim/spideryarn2/docs/postmortems/the-scroller-that-mounted-after-the-measure.md:79) overstates callback refs as the only answer. An effect keyed to the condition can be correct too; the real rule is that setup must follow the target node’s lifetime.

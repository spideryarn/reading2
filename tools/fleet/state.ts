 ...
 * Every field the server sends is now in the client's type unless it is NAMED
 * in an `Omit<>` there, which is a line a reviewer can see. wire.ts §
 * `FleetState` has the argument and the mutation proof.
 *

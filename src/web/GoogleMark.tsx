/**
 * Google's "G", as the pre-approved asset rather than as something we drew.
 *
 * The paths are Google's own four-colour mark, taken from its published button
 ...
 * reader mentions the empty square.
 */

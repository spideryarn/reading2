...
type Props = AnchorHTMLAttributes<HTMLAnchorElement> & {
  ...
  /* An `onNavigate` — called only when this tab really navigates, unlike
     `onClick`, which a ⌘-click reaches too — lived here from 2026-09-06 to
     2026-09-15 for one caller, the bar's Tweets link minting an activation
     token. The thread page now writes on arrival, so it went with its caller.
     If something needs to know about the *navigation* rather than the *click*
     again, 260906b § Stage 2 is the design. */
};
